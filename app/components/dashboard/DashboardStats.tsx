      ...
      <Card>
        ...
        <CardContent>
          <p className="text-2xl font-bold">
            Rp. {new Intl.NumberFormat("id-ID").format(totalAmount / 100)}
          </p>
          <p className="text-xs text-muted-foreground">Berdasarkan 100 pembelian terakhir</p>
        </CardContent>
      </Card>
      <Card>
        <CardHeader className="flex flex-row items-center justify-between pb-2">
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">
            Total Penjualan di PerkebunanWeb
          </p>
        </CardContent>
      </Card>
      <Card>
